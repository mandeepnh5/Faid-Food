  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-4 right-4 flex space-x-2">
        ...
        <Button variant="ghost" className="text-white">Signup</Button>
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md relative z-10">
        ...
        <h1 className="text-2xl font-bold text-center text-white mb-6">&quot;Join the Feast!&quot;</h1>
        <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
          ...
          />
          <Link to={'/home'}>
          <Button type="submit" className="w-full bg-green-500 hover:bg-green-600 mt-5">
            Create Account
          </Button>
          </Link>
        </form>
